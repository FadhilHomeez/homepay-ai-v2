...
class PaymentTerm(BaseModel):
    ...
    description: Optional[str] = Field(None, description="More detailed description of the payment milestone (e.g., '15% - Upon confirmation').")
    percentage: Optional[float] = Field(None, description="The percentage of the total project cost this payment represents.")
    title: Optional[str] = Field(None, description="The title or milestone for the payment.")

class InitialDeposit(BaseModel):
    amount: Optional[float] = Field(None, description="The monetary amount of the initial deposit.")
    description: Optional[str] = Field(None, description="More detailed description of the deposit (e.g., 'Booking fee').")
    percentage: Optional[float] = Field(None, description="The percentage of the total project cost this deposit represents.")
    title: Optional[str] = Field(None, description="The title for the deposit.")
...
class Quotation(BaseModel):
    ...
    property_type: Optional[str] = Field(None, description="The type of the property (e.g., 'HDB').")
    quotation_amount: Optional[float] = Field(None, description="The final total amount of the quotation.")
    quotation_date: Optional[str] = Field(None, description="The date the quotation was issued (e.g., '23-05-2025').")
